  ...
  <body>
    <a-scene>
		...
		<a-assets>
	    	...
	    	<a-asset-item id="myPlyModel" src="soybean_tanashi_x5rgb15m_20160725_group1_densified_point_cloudCollapsed.ply"></a-asset-item>
	  	</a-assets>
	  	<a-entity ply-model="src: #myPlyModel" position="0 -81.1 0" rotation="-90 0 0" ></a-entity>
